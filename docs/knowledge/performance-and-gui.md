...
> 来源 mod：75-SmoothDragSelect（本仓库含金量最高的性能笔记）
...
- 实测全量遍历约 **20ms/次**（来源：75-SmoothDragSelect 的压测）。
...
- 完整设计与数据：[`75-SmoothDragSelect/docs/superpowers/specs/2026-07-27-mouse-event-throttle-design.md`](../../75-SmoothDragSelect/docs/superpowers/specs/2026-07-27-mouse-event-throttle-design.md)
- 原文笔记：[`75-SmoothDragSelect/README.md`](../../75-SmoothDragSelect/README.md)
...
- 核心笔记：`75-SmoothDragSelect/README.md`
- 设计文档：`75-SmoothDragSelect/docs/superpowers/specs/2026-07-27-mouse-event-throttle-design.md`
